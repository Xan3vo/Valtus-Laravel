...
<main class="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-16">
    <div class="mb-6 sm:mb-8">
        <div class="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
            ...
            <h1 class="text-2xl sm:text-3xl md:text-4xl font-medium text-white/90">Tambah Admin</h1>
        </div>
        <p class="text-white/60 text-sm sm:text-base">Buat akun admin baru untuk mengelola sistem</p>
    </div>
    ...
    <div class="rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/0 p-6 sm:p-8">
        <form method="POST" action="{{ route('admin.admins.store') }}" class="space-y-6">
            ...
            <!-- Password Field -->
            <div class="space-y-2">
                <label for="password" class="block text-white/80 text-sm font-medium">Password</label>
                <input 
                    type="password" 
                    id="password" 
                    name="password" 
            ...
            <div class="space-y-2">
                <label for="password_confirmation" class="block text-white/80 text-sm font-medium">Konfirmasi Password</label>
                <input 
                    type="password" 
