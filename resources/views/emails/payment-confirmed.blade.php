...
<head>
    ...
    <title>Pembayaran Anda Sudah Dikonfirmasi</title>
</head>
    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background-color: #111827; border-radius: 8px; padding: 30px; border: 1px solid #374151;">
            ...
            <div style="color: #e5e7eb;">
                <h2 style="color: #ffffff; margin: 0 0 20px 0; font-size: 20px;">✅ Pembayaran Anda Sudah Dikonfirmasi</h2>
                
                <p style="margin: 0 0 20px 0; line-height: 1.6;">
                    Selamat! Pembayaran Anda telah dikonfirmasi oleh admin. Pesanan Anda sedang dalam antrian untuk diproses.
                </p>
                ...
                <div style="background-color: #1f2937; border-radius: 6px; padding: 20px; margin: 20px 0; border: 1px solid #374151;">
                    ...
                    <table style="width: 100%; color: #e5e7eb; font-size: 14px;">
                        ...
                        <tr>
                            ...
                            <td style="padding: 8px 0; text-align: right; color: #fbbf24;">Menunggu Proses</td>
                        </tr>
                    </table>
                </div>
                ...
                <p style="margin: 20px 0; line-height: 1.6; color: #9ca3af;">
                    ...
                    Tim kami sedang mempersiapkan pesanan Anda. Mohon menunggu untuk proses selanjutnya.
                </p>
                
                <p style="margin: 20px 0; line-height: 1.6; color: #9ca3af;">
                    Anda akan menerima notifikasi email lagi ketika pesanan Anda sudah diproses.
                </p>
